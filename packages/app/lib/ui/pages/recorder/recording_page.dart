                ...
                Center(
                   child: Column(
                     children: [
                       ...
                       ElevatedButton.icon(
                          icon: Icon(recorderService.isRecording ? Icons.stop : Icons.fiber_manual_record, 
                                     color: recorderService.isRecording ? Colors.grey : Colors.red),
                          label: Text(recorderService.isRecording ? 'STOP RECORDING' : 'START RECORDING'),
                          ...
                          onPressed: () {
                             if (recorderService.isRecording) {
                                 ...
                                 if (_selectedDevice != null) {
                                     recorderService.startRecording(_selectedDevice!, sampleRate: _sampleRate);
                                 }
                             }
                          },
                       ),
